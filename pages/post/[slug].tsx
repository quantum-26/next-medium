...
function Posts({ post }: Props) {
    ...
    const onSubmit: SubmitHandler<IFormInput> = async(data) => {
        ...
        await fetch('/api/createComment', {
            ...
            console.log('data coming after api');
            console.log(data);
            setSubmitted(true);
        }).catch((err) => {
            console.log(err);  
        ...
        <main>
            ...
            <article className='max-w-3xl mx-auto p-5'>
                ...
                <div className='mt-10'>
                    <PortableText 
                        ...
                        // serializers will set some rule what will happen when following thing
                        //  getting display
                        serializers={
                            {
                                h1: (props:any) => {
            ...
            { submitted ? (
                ...
                <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col p-5 max-w-2xl mx-auto mb-10'>
                    ...
                    <h4 className='text-3xl font-bold'>Leave a comment blelow</h4>
...
// tell next js which route to build prefetch 
// it will fetch all the slug and pass to getStatic Props
...
// it will fecth all the data for the slug passed
export const getStaticProps: GetStaticProps = async({ params }) =>{
    ...
    if( !post ){
        return {
            notFound: true // render 404 page in next js
        }
    }
    ...
    return {
        ...
        revalidate: 60, // ISR : fetch after 60 second
    }
}
